...
The development of GEOS-Chem-hyd has been multifaceted, here the current active branches are described:
...
Currently the version developments follow that of the default GEOS-Chem source code. The current implemented version is 14.0.0rc-3 with some up-to-date changes to the thermodynamics file that includes hetp
